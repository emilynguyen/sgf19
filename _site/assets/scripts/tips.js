...
var TIPS = ["Do NOT mix drugs and alcohol.", "Make sure to remain hydrated and drink about two cups of water (500ml) every hour. Be careful to not consume water too quickly- this can cause an electrolyte imbalance that could become fatal.", "You WILL NOT be punished for your drug/alcohol use retroactively if you seek help from an official. Your safety is our first priority.", "Eat before, during, and after the event.", "Alternate between alcoholic and non-alcoholic drinks.", "Choose beer or cider instead of shots.", "Keep track of the number of drinks you have (especially the amount of liquor).", "One drink is a 12 oz beer, 5 oz of wine, or 1.5 oz of liquor.", "Tell your friends to let you know when you’ve had too much to drink.", "Pace your drinks to one or less per hour, and avoid drinking games.", "Don’t take (or give) unwanted peer pressure", "Have a designated driver, or sign up for <a href='http://as.ucsd.edu/saferides' target='_blank'>A.S. Safe Rides</a>!", "If you see someone in medically dangerous conditions, do not be afraid to reach out to a security guard, police officer, event staff or event volunteer to ask for help.", "Consent is a voluntary, sober, imaginative, enthusiastic, creative, wanted, informed, mutual, honest, and verbal agreement. Consent is an active agreement: Consent cannot be coerced.", "A person who is intoxicated cannot legally give consent. If you're too drunk to make decisions and communicate with your partner, you're too drunk to consent.", "If you choose to drink, do so in moderation. Never take drinks from strangers, accept a drink from an open container or leave your drink unattended."];
